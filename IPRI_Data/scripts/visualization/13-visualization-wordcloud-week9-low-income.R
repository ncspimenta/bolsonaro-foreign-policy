# ─────────────────────────────────────────────────────────────
# Script: 13-visualization-wordcloud-week9-low-income.R
# Generates a wordcloud of responses to open-ended questions
# (P01 and P02) from Week 9 of the IPRI survey, filtered by
...
# (correcting for Week 11 mislabel not necessary here)
...
respostas_p9 <- bd9_filtrado %>%
  select(`P2_Out#1`)

# Note: One P01 column was excluded by the interviewers in Week 9,
# reducing representativeness slightly.
