# ─────────────────────────────────────────────────────────────
# Script: 15-visualization-wordcloud-week17-low-income.R
# Generates a wordcloud of responses to open-ended questions
# (P01 and P02) from Week 17 of the IPRI survey, filtered by
...
respostas_p17 <- bd17_filtrado %>%
  select(`P1_Out#1`, `P2_Out#1`)

# Combine into single text vector
texto_completo <- respostas_p17 %>%
