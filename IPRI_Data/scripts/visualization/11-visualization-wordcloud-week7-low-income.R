# ─────────────────────────────────────────────────────────────
# Script: 11-visualization-wordcloud-week7-low-income.R
# Generates a wordcloud of responses to open-ended questions 
# (P01 and P02) from Week 7 of the IPRI survey, limited to
...
# Valid text and numeric labels for this income range
income_filter <- c(
...
respostas <- bd7_filtered %>%
  select(`P1_Out#1`, `P2_Out#1`)

# Combine into a single text vector
